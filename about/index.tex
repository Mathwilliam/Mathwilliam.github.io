...
\firstname{HongJiang} % Your first name
\familyname{Qian} % Your last name

% All information in this block is optional, comment out any lines you don't need
%\title{Curriculum Vitae}
\address{TongLiang}{ChongQing China}
\mobile{139-7106-9528}
%\phone{(000) 111 1112}
%\fax{(000) 111 1113}
\email{410786550@qq.com}
